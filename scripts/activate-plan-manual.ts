 ...
 * Uso: npx tsx scripts/activate-plan-manual.ts credifast365@outlook.com
 */
...
const period = (process.argv[4] || 'monthly') as 'monthly' | 'yearly'
...
async function activatePlan() {
  ...
  try {
    ...
    if (verifyError) {
      ...
      console.log(`   - Plan: ${(updatedProfile?.plan as any)?.nombre}`)
