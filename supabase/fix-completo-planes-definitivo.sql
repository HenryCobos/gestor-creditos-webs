...
RAISE NOTICE '✅ Trigger anterior eliminado';
...
BEGIN
  ...
  RAISE NOTICE '✅ Perfil creado/actualizado para usuario: %', NEW.email;
  RETURN NEW;
EXCEPTION
  WHEN OTHERS THEN
...
RAISE NOTICE '✅ Perfiles sin plan actualizados';
...
RAISE NOTICE '✅ Usuarios sin pago corregidos al plan gratuito';
...
-- ✅ Trigger debe aparecer en la última query
-- =====================================================
