-- =====================================================
-- FIX: Eliminar funciones existentes y recrearlas
-- =====================================================
...
DROP FUNCTION IF EXISTS public.get_pagos_segun_rol() CASCADE;
DROP FUNCTION IF EXISTS public.puede_acceder_cliente(UUID) CASCADE;
DROP FUNCTION IF EXISTS public.puede_acceder_prestamo(UUID) CASCADE;

-- =====================================================
-- 1. get_clientes_segun_rol() - TODAS las columnas
-- =====================================================
CREATE FUNCTION public.get_clientes_segun_rol()
RETURNS TABLE (
  id UUID,
  user_id UUID,
  nombre TEXT,
...
-- =====================================================
CREATE FUNCTION public.get_prestamos_segun_rol()
RETURNS TABLE (
  id UUID,
  user_id UUID,
  cliente_id UUID,
...
-- =====================================================
CREATE FUNCTION public.get_cuotas_segun_rol()
RETURNS TABLE (
  id UUID,
  user_id UUID,
  prestamo_id UUID,
...
-- VERIFICACIÓN
-- =====================================================
SELECT '✅ Funciones recreadas exitosamente' as resultado;
